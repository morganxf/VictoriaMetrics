...
func TestRequestParams(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			&VMStorage{},
			func(t *testing.T, r *http.Request) {
				exp := url.Values{"query": []string{query}, "time": []string{timestamp.Format(time.RFC3339)}}
		...
		},
		{
			...
			func(t *testing.T, r *http.Request) {
				exp := url.Values{"query": []string{query}, "time": []string{timestamp.Add(-time.Minute).Format(time.RFC3339)}}
				checkEqualString(t, exp.Encode(), r.URL.RawQuery)
			},
		},
		{
			...
			func(t *testing.T, r *http.Request) {
				...
				exp := url.Values{"query": []string{query}, "step": []string{evalInterval.String()}, "time": []string{tt.Format(time.RFC3339)}}
				checkEqualString(t, exp.Encode(), r.URL.RawQuery)
			},
		},
		{
		...
		},
		{
			...
			func(t *testing.T, r *http.Request) {
				exp := url.Values{"query": []string{query}, "step": []string{fmt.Sprintf("%ds", int(time.Minute.Seconds()))}, "time": []string{timestamp.Format(time.RFC3339)}}
				checkEqualString(t, exp.Encode(), r.URL.RawQuery)
			},
		},
		{
			...
			func(t *testing.T, r *http.Request) {
				...
				tt := timestamp.Truncate(evalInterval)
				exp := url.Values{"query": []string{query}, "step": []string{fmt.Sprintf("%ds", int(evalInterval.Seconds()))}, "time": []string{tt.Format(time.RFC3339)}}
				checkEqualString(t, exp.Encode(), r.URL.RawQuery)
			},
		},
		{
			...
			func(t *testing.T, r *http.Request) {
				exp := url.Values{"query": []string{query}, "round_digits": []string{"10"}, "time": []string{timestamp.Format(time.RFC3339)}}
				checkEqualString(t, exp.Encode(), r.URL.RawQuery)
			},
		},
		{
		...
		},
		{
			...
			func(t *testing.T, r *http.Request) {
				exp := url.Values{"query": []string{query}, "round_digits": []string{"2"}, "time": []string{timestamp.Format(time.RFC3339)}}
				checkEqualString(t, exp.Encode(), r.URL.RawQuery)
			},
		},
		{
